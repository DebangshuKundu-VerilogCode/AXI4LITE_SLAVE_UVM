class scoreboard extends uvm_scoreboard;
    ...
    logic [31:0] exp_data;
    logic [31:0] prev_data;          // added: old memory content captured before a write
    int pass, fail;
    ...
    virtual task ref_model(trans t);
        ...
        if(t.w_r) begin
            if (t.order==3'd4) begin
                // ---- read part of the simultaneous transaction ----
                ...
                // ---- write part of the simultaneous transaction ----
    ...
    virtual task compare_output();
        if(inp_mon.w_r) begin
            if(inp_mon.order==3'd4) begin
                // write response
